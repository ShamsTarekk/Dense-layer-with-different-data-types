...
--        MEM_INIT_INPUTS : in work.my_types.mem_inputs32;
--        MEM_INIT_WEIGHTS : in work.my_types.mem_weights32;
--        MEM_INIT_BIASES : in work.my_types.mem_biases32;
--        clk       : in  std_logic;
--		rst_n     : in  std_logic;
--		start     : in  std_logic;
...
--architecture behavior of fsm_dense_fp32 is
...
--    type mo  is array (0 to 9, 0 to 63) of float32;
--    type mi1 is array (0 to 63) of float32;
--    type bi  is array (0 to 9)  of float32;

--    signal state : state_type := S_IDLE;

--    signal MEM_weights_2d : mem2d32_t;
...
--    component getting_Address_of_maxfp32 is
--        Port (
--            clk : in std_logic;
--            act1,act2,act3,act4,act5,act6,act7,act8,act9,act10 : in float32;
...
--    add_req: getting_Address_of_maxfp32
--        port map(
--            clk => clk,
...
--                            weight_buf(y,i) <= to_float(to_2d32(MEM_INIT_WEIGHTS)(y,i), 8, 23);
--                        end loop;
--                    end loop;

--                    for i in 0 to 63 loop
--                        input_buf(i) <= to_float(MEM_INIT_INPUTS(v_image_idx*64 + i), 8, 23);
--                    end loop;

--                    for k in 0 to 9 loop
--                        bias_buf(k) <= to_float(MEM_INIT_BIASES(k), 8, 23);
--                    end loop;
