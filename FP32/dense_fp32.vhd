...
--architecture Behavioral of Dense_fp32 is

--    type mo is array (0 to 63, 0 to 9) of float32;

--    signal mult_output : mo;
--    signal acc_output  : float32_array(0 to 9);
...
--    GET_MAX: getting_Address_of_maxfp32
--        port map (
--            clk => clk,
