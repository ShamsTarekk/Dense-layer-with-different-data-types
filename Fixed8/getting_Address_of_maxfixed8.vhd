...
entity getting_Address_of_maxfixed8 is
  Port (
    clk    : in  std_logic;
    act1,act2,act3,act4,act5,act6,act7,act8,act9,act10  : in  sfixed(3 downto -4);
    address : out std_logic_vector(3 downto 0)
  );
end getting_Address_of_maxfixed8;

architecture Behavioral of getting_Address_of_maxfixed8 is
begin
process(clk)
begin
