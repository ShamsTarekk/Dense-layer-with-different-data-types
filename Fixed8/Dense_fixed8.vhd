...
architecture Behavioral of Dense_fixed8 is

    type mo is array (0 to 63, 0 to 9) of fixed8;

    signal mult_output : mo;
    signal acc_output  : fixed8_array(0 to 9);
    ...
    component getting_Address_of_maxfixed8 is
        port (
            clk      : in std_logic;
            act1,act2,act3,act4,act5,act6,act7,act8,act9,act10 : in fixed8;
...
begin
    ...
    GET_MAX: getting_Address_of_maxfixed8
        port map (
            clk => clk,
