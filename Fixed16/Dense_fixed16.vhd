...
architecture Behavioral of Dense_fixed16 is

    type mo is array (0 to 63, 0 to 9) of fixed16;

    signal mult_output : mo;
    signal acc_output  : fixed16_array(0 to 9);
    ...
    component getting_Address_of_maxfixed16 is
        port (
            clk      : in std_logic;
            act1,act2,act3,act4,act5,act6,act7,act8,act9,act10 : in fixed16;
...
begin
    ...
    --------------------------------------------------------------------
    -- MAX ADDRESS DETECTION
    --------------------------------------------------------------------
    GET_MAX: getting_Address_of_maxfixed16
        port map (
            clk => clk,
