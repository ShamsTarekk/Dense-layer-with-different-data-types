...
architecture Behavioral of Dense_fp16 is

    type mo is array (0 to 63, 0 to 9) of float16;

    signal mult_output : mo;
    signal acc_output  : float16_array(0 to 9);
    ...
    component getting_Address_of_maxfp16 is
        port (
            clk : in std_logic;
            act1,act2,act3,act4,act5,act6,act7,act8,act9,act10 : in float16;
...
begin
    ...
    GET_MAX: getting_Address_of_maxfp16
        port map (
            clk => clk,
